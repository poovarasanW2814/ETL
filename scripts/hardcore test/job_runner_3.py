...
COLUMN_CONFIGS = [
    ("order_date", "order_date_fmt", "Convert order_date to ISO format"),
    ("ship_date", "ship_date_fmt", "Convert ship_date to DD-MM-YYYY"),
    ("paid_at", "paid_at_fmt", "Convert paid_at to YYYY-MM-DD HH:mm:ss"),
]
...
def generate_dates(count: int) -> list[str]:
    ...
    for _ in range(count):
        rand_days = random.randint(0, 2100)
