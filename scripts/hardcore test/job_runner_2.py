...
COLUMN_CONFIGS = [
    ("invoice_date", "invoice_date_fmt", "Convert invoice_date to ISO format"),
    ("delivery_date", "delivery_date_fmt", "Convert delivery_date to DD-MM-YYYY"),
    ("approved_at", "approved_at_fmt", "Convert approved_at to YYYY-MM-DD HH:mm:ss"),
]
...
def generate_dates(count: int) -> list[str]:
    ...
    for _ in range(count):
        rand_days = random.randint(0, 1600)
