...
COLUMN_CONFIGS = [
    ("created_at", "created_at_fmt", "Convert created_at to ISO format"),
    ("join_date", "join_date_fmt", "Convert join_date to DD-MM-YYYY"),
    ("last_login", "last_login_fmt", "Convert last_login to YYYY-MM-DD HH:mm:ss"),
]
...
def generate_dates(count: int) -> list[str]:
    ...
    for _ in range(count):
        rand_days = random.randint(0, 1800)
